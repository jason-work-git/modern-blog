    ...
    <footer className="relative z-10 py-8 border-t border-gray-200">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        <div className="flex flex-wrap items-center justify-center flex-col gap-4 lg:gap-0 lg:flex-row lg:justify-between">
          <div>
            <p className="text-sm">© 2025 Clarity. All rights reserved</p>
          </div>
          ...
          <div>
            <ul className="flex flex-wrap items-center gap-2.5">
              <li>
                <Link
                  href="/privacy-policy"
                  className="group leading-none flex text-sm ease-in duration-200 hover:text-gray-800"
                >
                  <span className="bg-gradient-to-r from-gray-800 to-gray-800 bg-[length:0px_1px] bg-left-bottom bg-no-repeat transition-[background-size] duration-500 hover:bg-[length:100%_1px] group-hover:bg-[length:100%_1px]">
                    Privacy
                  </span>
                </Link>
              </li>
          ...
          <div>
            <div className="flex items-center gap-3">
              <p className="font-medium text-sm text-gray-800">Follow Us:</p>
              ...
              <div className="flex items-center gap-1.5">
                <a
                  ...
                  href="#"
                  className="flex items-center justify-center w-[30px] h-[30px] rounded-full hover:bg-gray-100 lg:transition-all lg:ease-linear lg:duration-300 hover:text-gray-800"
                >
                  <svg
